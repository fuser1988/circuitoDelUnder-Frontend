...
function IniciativaRecitalPage(props) {
    ...
    const traerTodasLasIniciativas = (page) => {
        ...
        .then((response) => {
            setIniciativaRecitales(response.content);
    ...
    const grilla = () => {
        return (
            <div>
                {iniciativaRecitales.map((iniciativa) => {
                    return (<div className="formulario-carga-banda background-form ">
                    <div className="mt-3 pt-4 " >
                        <Row>
                            <Col md="3" className="">
                                <div className="d-flex justify-content-center">
                                    <img alt="..." className="" src={iniciativa.usuario.banda.imagen} />
                                </div>
                            ...
                            <Col md="9">
                                ...
                                <div className="row d-flex justify-content-start ml-1 mt-3">
                                    ...
                                    <p className="ml-2">{iniciativa.lugar}.</p>
                                    <span className="badge badge-info ml-3">Fecha</span>
                                    <p className="ml-2">{iniciativa.fecha}</p>
            ...
            >
                ...
                <Container className="formulario-angosto">
                    ...
                    <div className="formulario-carga-banda background-form  mb-4">
                        ...
                        {/*cargandoIniciativa ? <Spinner /> :*/ iniciativaGrilla()}
